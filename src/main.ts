...
function update_count_and_reset_counter(): void {
  const start_at_value: number = Number(
    (document.getElementById("start_at") as HTMLInputElement)?.value,
  );
  const step_value: number = Number(
...
const start_at_control: HTMLInputElement | null = document.getElementById(
  "start_at",
) as HTMLInputElement;

const step_control: HTMLInputElement | null = document.getElementById(
  "step",
) as HTMLInputElement;
...
const count_button: HTMLButtonElement | null = document.querySelector(
  ".count_button",
) as HTMLButtonElement;

const current_count: HTMLSpanElement | null = document.querySelector(
  ".current_count",
) as HTMLSpanElement;
